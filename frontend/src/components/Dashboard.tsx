...
function ListIconButton({ title = "Item", link = "/", icon }) {
    return (
        <>
            <a href={link} className="DashboardListIconButton">
                <div className="DashboardListIcon">{icon}</div>
                <span>{title}</span>
            </a>
        </>
    )
...
function PageHeader({ title = "Page", accountName = "Account" }) {
    return (
        <>
            <div className="DashboardPageHeader">
                ...
                <span id="dashboard-title">{title}</span>
                ...
                <GridItem colSpan={1}>
                    <Sidebar>
                        ...
                        <ListSection sectionTitle="Helpdesk">
                            <ListIconButton title="Tickets" icon={<IconTicket />} />
                            <ListIconButton title="Knowledgebase" link="/incidents/plan" icon={<IconLibrary />} />
                        </ListSection>
                        <SectionDivider />
                        <ListSection sectionTitle="Incident Response">
                            <ListIconButton title="Reports" icon={<IconClipboardText />} />
                            <ListIconButton title="Plan" link="/incidents/plan" icon={<IconListCheck />} />
                        </ListSection>
                        <SectionDivider />
                        <ListSection sectionTitle="Finance">
                            <ListIconButton title="Orders" link="/finance/orders" icon={<IconCreditCard />} />
                        </ListSection>
                        <SectionDivider />
                        <ListSection sectionTitle="Management">
                            <ListIconButton title="Users" icon={<IconUsers />} />
                            <ListIconButton title="General" icon={<IconSettings />} />
                            <ListIconButton title="Security" icon={<IconShieldCog />} />
                        </ListSection>
                    </Sidebar>
                </GridItem>
                <GridItem colSpan={11}>
